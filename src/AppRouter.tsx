        ...
        <>
            <BrowserRouter basename={"/"}>
                <Routes>
                    ...
                    <Route path="auth/pay/regular?projectId=:projectId" element={<RegularPaymentScreen />} />
                    <Route path="auth/pay/onetime?projectId=:projectId" element={<OneTimePaymentScreen />} />
